...
class _ProfileSelectScreenState extends State<ProfileSelectScreen> {
  ...
  Future<void> _submitCreate() async {
    ...
    final p = await ProfileService()
        .createProfile(name, _selectedClass, _selectedAvatar);
    if (!mounted) return;
    await _pick(p);
  }
        ...
        child: ConstrainedBox(
          ...
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text('Typing',
                  style: AppTheme.heading(34, color: AppTheme.primary)),
              Text('Quest',
                  style: AppTheme.heading(34, color: AppTheme.gold)),
            ]),
        ...
        child: Container(
          ...
          child: Column(
            ...
            Row(children: [
              ...
              Expanded(
                child: Text(isEdit ? 'Edit Profile' : 'New Profile',
            ...
            Text(
              isEdit
                  ? 'Update your name, avatar or class.'
                  : 'Progress is saved separately per profile.',
            ...
            Wrap(
              ...
              children: _kAvatars.map((avatar) {
                final isSelected = _selectedAvatar == avatar;

                // Only the selected avatar item needs AnimatedContainer.
                // The 26 non-selected items are plain Containers, saving
                // 26 animation objects being evaluated on every tap.
                if (isSelected) {
            ...
            Wrap(
              ...
              children: _kClasses.map((cls) {
                ...
                // Same pattern as avatars — animate only the selected chip.
                if (isSelected) {
                  return GestureDetector(
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow:
              _hovered || widget.isActive ? AppTheme.softShadow : null,
        ),
        child: Row(children: [
          Expanded(
          ...
          if (widget.onDelete != null) ...[
            Container(
                width: 1, height: 52, color: AppTheme.cardBorder),
            _IconAction(
