  ...
  Future<void> _connect() async {
    ...
    if (ip.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter the host IP address'),
  ...
  Widget _buildJoinPanel() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Ask the host for their IP address and enter it below.',
        ...
        const SizedBox(height: 8),
        // keyboardType and textCapitalization removed — keyboard-only app,
        // these properties triggered on-screen keyboards on touch devices
        TextField(
        ...
        const SizedBox(height: 8),
        // keyboardType removed — no touch keyboard in this app
        TextField(
        ...
        SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            label: Text(
              _connecting ? 'Connecting...' : 'CONNECT & JOIN',
  ...
  Widget _buildWaitingPanel() {
    return Column(
      ...
      children: [
        ...
        Text('Connected!',
            style: AppTheme.heading(28, color: AppTheme.success)),
        const SizedBox(height: 8),
        Text(
...
class _AnimatedWaitingState extends State<_AnimatedWaiting>
  ...
  void initState() {
    super.initState();
    // Single controller drives the dots without extra timers
