      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          Container(
            ...
            child: Text('TQ',
                style: AppTheme.heading(14, color: AppTheme.primary)),
          ),
              ...
              child: GestureDetector(
                onTap: () async {
                  final switched = await Navigator.push<bool>(
                    ...
                    MaterialPageRoute(
                        builder: (_) =>
                            const ProfileSelectScreen(switchMode: true)),
                  );
      ...
      body: Column(
        children: [
          if (ProfileService().isGuest)
            _GuestBanner(onCreateProfile: () async {
            ...
            child: Column(
              ...
              children: [
                ...
                if (profile != null && !ProfileService().isGuest) ...[
                  ...
                  Text(
                    '${profile.avatar}  ${profile.name}  ·  ${profile.className}',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: AppTheme.gold.withValues(alpha: 0.25)),
        ),
      ),
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          // Material + InkWell gives you hover feedback & cursor in one go
          Material(
            color: AppTheme.primary,
            borderRadius: BorderRadius.circular(20),
            child: InkWell(
              ...
              borderRadius: BorderRadius.circular(20),
              // This handles the hover color and the click ripple
...
class _SettingRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(children: [
          ...
          // Fixed: `?trailing` was invalid Dart syntax — replaced with a
          // proper null-check guard.
          ?trailing,
        ]),
      );
}