    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        onTap: () => Navigator.push(
          ...
          MaterialPageRoute(
              builder: (_) =>
                  LevelSelectScreen(difficulty: widget.difficulty)),
        ),
            ...
            children: [
              ...
              Row(children: [
                ...
                Container(
                  ...
                  child: Text(widget.difficulty.emoji,
                      style: const TextStyle(fontSize: 16)),
                ),
              ]),
              const SizedBox(height: 20),

              Text(widget.difficulty.label.toUpperCase(),
              ...
              // Beginner hint — updated to reflect keyboard-guide approach
              // (no touch / on-screen keyboard is provided).
              if (widget.difficulty == Difficulty.beginner) ...[
                ...
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text(
                      'Finger placement guide included',
...
class _GridPainter extends CustomPainter {
  // Static cached Paint — not recreated on every paint call.
  static final Paint _paint = Paint()
    ..color       = const Color(0x085C7CFA) // primary @ 3 %
    ..strokeWidth = 1;
