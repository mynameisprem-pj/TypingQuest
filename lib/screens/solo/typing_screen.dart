...
class _TypingScreenState extends State<TypingScreen>
  ...
  // _typedText was a dead variable — it was appended to on every keypress
  // but never read anywhere in the UI. Removed.
  int  _currentIndex = 0;
  ...
  // Keyboard visibility thresholds
  bool get _showKeyboard =>
      widget.difficulty == Difficulty.beginner && widget.level <= 70;
  bool get _showHints =>
      widget.difficulty == Difficulty.beginner && widget.level <= 50;
  ...
  void _handleKeyEvent(KeyEvent event) {
    ...
    if (char == expected) {
      ...
      // HapticFeedback.heavyImpact() removed — touch-device API only,
      // not applicable when physical keyboard is required.
    }
  }
  ...
  void _onFinish() {
    ...
    final accuracy = ((_targetText.length - _errorCount) /
                _targetText.length *
                100)
            .clamp(0, 100)
            .toDouble();
    final stars = LevelResult.calculateStars(
        accuracy, _wpm,
        TypingContent.targetWpm(widget.difficulty, widget.level));
      ...
      body: KeyboardListener(
        ...
        child: Column(
          children: [
            ...
            if (_showKeyboard)
              VirtualKeyboard(
                highlightChar: _finished
                    ? null
                    : (_currentIndex < _targetText.length
                        ? _targetText[_currentIndex]
                        : null),
      ...
      title: Row(children: [
        Container(
          ...
          child: Text(widget.difficulty.label,
              style: AppTheme.body(12, color: _difficultyColor)),
        ),
      ...
      child: Padding(
        ...
        child: SlideTransition(
          ...
          child: Column(
            ...
            children: [
              // Hint banner (beginner levels only)
              if (!_started &&
                  widget.difficulty == Difficulty.beginner &&
                  widget.level <= 20)
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    const SizedBox(width: 8),
                    Text(
                      'Watch the keyboard below. Type the highlighted key!',
              ...
              if (!_started)
                Column(children: [
                  ...
                  Text(
                    '⏱  You have ${_timeLimit ~/ 60}:${(_timeLimit % 60).toString().padLeft(2, '0')} to complete this level',
          ...
          return WidgetSpan(
            child: Container(
              ...
              decoration: bg != null
                  ...
                  : null,
              child: Text(char, style: AppTheme.mono(22, color: color)),
            ),
          );
        }),
      ),
    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Stars — easeOutCubic instead of elasticOut (no spring physics)
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
            ...
            Row(children: [
              ...
              Container(
                  width: 1, height: 40, color: AppTheme.cardBorder),
              Expanded(
                  child: _ResultStat(
                      label: 'ACCURACY',
...
class _CountdownChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final barColor  = isLow ? AppTheme.error
        : fraction > 0.5 ? AppTheme.success : AppTheme.gold;
    final textColor = isLow ? AppTheme.error : AppTheme.textSecondary;
    ...
    return Transform.scale(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
              color: barColor.withValues(alpha: 0.4 + glowOpacity)),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(mainAxisSize: MainAxisSize.min, children: [
              Text(_fmt(timeLeft),
                  style: AppTheme.heading(16, color: textColor)),
              const SizedBox(width: 6),
              SizedBox(
                width: 48, height: 4,
                child: ClipRRect(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: AppTheme.error.withValues(alpha: 0.4), width: 2),
            ),
            child: const Center(
          ...
          const SizedBox(height: 16),
          Text("TIME'S UP!",
              style: AppTheme.heading(24, color: AppTheme.error)),
          const SizedBox(height: 6),
